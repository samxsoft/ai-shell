...
<img src="docs/images/demo.gif" alt="AI-Shell 核心交互演示" width="880" style="border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,0.3);" />
...
| 平台 (Platform) | 安装包格式 (Package) | 架构 (Arch) | 状态 / 下载入口 |
| :--- | :--- | :--- | :--- |
| 🪟 **Windows 10 / 11** | `.msi` 安装向导 / `.exe` 便携版 | x86_64 | [👉 点击前往下载 Windows 最新版](https://github.com/samxsoft/ai-shell/releases/latest) |
| 🍎 **macOS** | `.dmg` 镜像安装包 | Universal | *后续版本规划中* |
| 🐧 **Linux** | `.deb` / `.AppImage` | x86_64 | *后续版本规划中* |
...
- [x] 本地 GGUF 模型库 (Rust 多线程断点续传/流式下载器，支持 0.5B/1.5B/3B 小型量化模型)
- [x] OpenWALDO 纯血开源模型生态接入与预设配置
- [x] 100% 完整中英文 (zh-CN / en-US) 多语言支持
- [x] 深色黑曜石 / 明亮清新 / 跟随系统色彩主题
- [ ] 内置 Rust 原生推理引擎 (llama.cpp / candle)，实现 100% 零外部依赖完全离线排障
